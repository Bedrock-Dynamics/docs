...
<Info>
  Toggle recording from the toolbar to capture live data streams into MCAP format. Recordings can be replayed later in the [Data Playback](/substrate/features/flight-review) panel or exported for analysis in external tools.
</Info>
